			...
			<table class="input-group-table">
				...
				<tr>
					...
					<td><input type="text" name="username" autofocus="autofocus"
						required="required" placeholder="10자 이내 (ex: 한승훈)"
				...
				<tr>
					<th>Github</th>
					<td><input type="text" name="github" placeholder="자신의 깃허브 URL"
						value="${dto.github}" /></td>
				</tr>
				<tr>
					<th>Blog</th>
				...
				<tr>
					<th>Acmicpc Rank</th>
					<td><input type="text" name="acmicpc_rank" placeholder="백준 랭킹"
						value="${dto.acmicpc_rank}" /></td>
				</tr>
				...
				<tr>
					<th>Award Name</th>
					<td><input type="text" name="award_name" placeholder="20자 이내"
				...
				<tr>
					<th>Major</th>
					<td><input type="text" name="major" placeholder="10자 이내"
						value="${dto.major}" /></td>
				</tr>
				<tr>
					<th>Company</th>
				...
				<tr>
					<th>Job</th>
					<td><input type="text" name="job" placeholder="10자 이내"
						value="${dto.job}" /></td>
				</tr>
				<tr>
					<th>Password</th>
